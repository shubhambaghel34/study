...
namespace Coyote.Execution.CheckCall.Endpoint
{
    using System;
    ...
    using Business.Events.Publisher.Contracts;
    using Business.Events.Publisher.Contracts.Events;
    using System.Configuration;
    using Coyote.Execution.CheckCall.Storage;

    [EndpointName("Coyote.Execution.CheckCall.Endpoint")]
    public class EndpointConfig : IConfigureThisEndpoint
    {
        public void Customize(BusConfiguration configuration)
        {
            ...
            configuration.Conventions()
                ...
                || typeof(IBusinessEvent).IsAssignableFrom(t));


            //Scan Assemblys for Messaging Handlers
            configuration.AssembliesToScan(
                Assembly.GetExecutingAssembly(),
                Assembly.Load("Coyote.Execution.CheckCall.Contracts"),
                Assembly.Load("Coyote.Business.Events.Publisher.Contracts"),
