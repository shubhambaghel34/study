...
namespace Coyote.Execution.CheckCall.Endpoint.CustomChecks
{
    using System;
    ...
    public class MonitorDBConnection : PeriodicCheck
    {
        ...
        public MonitorDBConnection(IAuditUserRepository auditUserRepository)
            : base("Daily Check Call Bazooka Database", "Network resources", TimeSpan.FromSeconds(60))
        {
        ...
        public override CheckResult PerformCheck()
        {
            try
            {
                var result = AuditUserRepository.GetAuditUserId("Coyote.Execution.CheckCall");
            }
            catch (Exception ex)
            {
