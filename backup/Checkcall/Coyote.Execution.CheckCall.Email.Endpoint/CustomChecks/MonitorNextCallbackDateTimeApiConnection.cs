...
namespace Coyote.Execution.CheckCall.Email.Endpoint.CustomChecks
{
    ...
    public class MonitorNextCallbackDateTimeApiConnection : PeriodicCheck
    {
        public MonitorNextCallbackDateTimeApiConnection()
            : base("Daily Check Call Email - Next Callback DateTime API connection", "Network resources", TimeSpan.FromMinutes(5))
        { }
        ...
        {
            var url = $"{ConfigurationManager.AppSettings["NextCallbackDateTimeServiceUri"]}/help";
            ...
            return CheckResult.Failed($"Unable to contact Next Callback DateTime Core Service at : '{url}'");
        }
    }
}
